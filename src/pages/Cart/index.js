      ...
      <Column className="bg-white_A700 font-poppins items-start justify-start mx-[auto] w-[100%]">
        ...
        <Row className="items-center justify-start mt-[100px] lg:mt-[58px] xl:mt-[66px] 2xl:mt-[75px] 3xl:mt-[90px] mx-[auto] w-[84%]">
          <Row className="items-center justify-between w-[41%]">
            ...
            <Line className="bg-gray_800 h-[2px] lg:mb-[15px] xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] lg:mt-[16px] xl:mt-[18px] 2xl:mt-[21px] 3xl:mt-[25px] mt-[28px] w-[58%]" />
          </Row>
          <Row className="items-center justify-center lg:ml-[33px] xl:ml-[38px] 2xl:ml-[42px] 3xl:ml-[51px] ml-[57px] w-[40%]">
            ...
            <Line className="bg-bluegray_100 h-[2px] lg:mb-[15px] xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] lg:ml-[32px] xl:ml-[37px] 2xl:ml-[42px] 3xl:ml-[50px] ml-[56px] lg:mt-[16px] xl:mt-[18px] 2xl:mt-[21px] 3xl:mt-[25px] mt-[28px] w-[60%]" />
          </Row>
        ...
        <Column className="items-start justify-start lg:mt-[46px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] mt-[80px] mx-[auto] w-[85%]">
            ...
            <Column className="items-center justify-start w-[100%]">
              <Column className="items-center justify-start w-[100%]">
                <Column className="items-center justify-start w-[100%]">
                  <Row className="items-start justify-between w-[100%]">
                    <Text className="font-medium xl:mb-[2px] lg:mb-[2px] 3xl:mb-[3px] 2xl:mb-[3px] mb-[4px] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_500 w-[auto]">
                      Product
                    </Text>
                ...
                >
                  <Column className="items-center justify-start xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] my-[16px] lg:my-[9px] w-[100%]">
                    <Row className="items-center justify-start w-[100%]">
                      ...
                      <Text className="font-medium lg:ml-[38px] xl:ml-[44px] 2xl:ml-[49px] 3xl:ml-[59px] ml-[66px] lg:my-[47px] xl:my-[54px] 2xl:my-[61px] 3xl:my-[73px] my-[82px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-[24px] text-gray_800 w-[auto]">
                        Gray T-shirt
                      </Text>
                      ...
                      <Text className="font-medium 2xl:ml-[104px] 3xl:ml-[125px] ml-[139px] lg:ml-[81px] xl:ml-[92px] lg:my-[47px] xl:my-[54px] 2xl:my-[61px] 3xl:my-[73px] my-[82px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-[24px] text-gray_800 w-[auto]">
                        $100.99
                      </Text>
                      <Text className="font-medium lg:ml-[108px] xl:ml-[124px] 2xl:ml-[139px] 3xl:ml-[167px] ml-[186px] lg:my-[47px] xl:my-[54px] 2xl:my-[61px] 3xl:my-[73px] my-[82px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-[24px] text-gray_800 w-[auto]">
                        $100.99
                      </Text>
                      <Image
                        src={"images/img_.svg"}
              ...
              <Row className="items-start justify-between lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
                <Stack className="lg:h-[35px] xl:h-[41px] 2xl:h-[46px] 3xl:h-[55px] h-[60px] lg:mb-[21px] xl:mb-[24px] 2xl:mb-[27px] 3xl:mb-[33px] mb-[37px] w-[28%]">
                  <Input
                    className="absolute bg-transparent border-0 font-normal not-italic xl:pb-[12px] 3xl:pb-[16px] pb-[18.55px] xl:pl-[10px] 2xl:pl-[12px] 3xl:pl-[14px] pl-[16px] lg:pl-[9px] xl:pt-[11px] 3xl:pt-[15px] pt-[17.55px] lg:py-[10px] 2xl:py-[13px] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] placeholder:text-gray_500 text-gray_500 tracking-ls1 w-[100%]"
                    WrapClassName="absolute border border-bluegray_100 border-solid inset-[0] m-[0] w-[100%]"
                    name="Group82"
                    placeholder="Enter coupon code"
                  ></Input>
                  <Button className="absolute bg-gray_800 font-normal not-italic lg:py-[10px] xl:py-[12px] 2xl:py-[13px] 3xl:py-[16px] py-[18.05px] right-[0] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-center text-white_A700 w-[30%]">
                    Apply Code
                  </Button>
                </Stack>
                <Column className="items-start justify-start w-[9%]">
                  <Text className="font-medium lg:ml-[56px] xl:ml-[64px] 2xl:ml-[72px] 3xl:ml-[87px] ml-[97px] lg:mr-[1px] 3xl:mr-[2px] 2xl:mr-[2px] xl:mr-[2px] mr-[3px] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_500 w-[auto]">
                    Total
                  </Text>
                  <Column className="items-start xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] w-[100%]">
          ...
          <Row className="items-center justify-end ml-[auto] lg:mt-[46px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] mt-[80px] w-[25%]">
            <Button className="border border-gray_800 border-solid font-medium 3xl:py-[10px] py-[12.04px] lg:py-[7px] xl:py-[8px] 2xl:py-[9px] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-center text-gray_800 w-[50%]">
              Continue Shopping
            </Button>
            <Button
              className="common-pointer bg-gray_800 font-medium lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] ml-[32px] 3xl:py-[10px] py-[12.04px] lg:py-[7px] xl:py-[8px] 2xl:py-[9px] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-center text-white_A700 w-[42%]"
