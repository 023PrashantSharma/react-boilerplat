      ...
      <Column className="bg-white_A700 font-poppins items-center justify-start mx-[auto] w-[100%]">
            ...
            <Column className="items-center justify-start w-[100%]">
              <Row className="bg-white_A700 items-center justify-start w-[100%]">
                ...
                <Image
                  ...
                  className="lg:h-[14px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] h-[24px] lg:ml-[345px] xl:ml-[394px] 2xl:ml-[444px] 3xl:ml-[533px] ml-[592px] 2xl:mr-[108px] 3xl:mr-[129px] mr-[144px] lg:mr-[84px] xl:mr-[96px] lg:my-[21px] xl:my-[24px] 2xl:my-[27px] 3xl:my-[32px] my-[36px] object-contain w-[9%]"
                  alt="icon"
                />
              </Row>
            ...
            <Row className="bg-white_A700 lg:gap-[14px] xl:gap-[16px] 2xl:gap-[18px] 3xl:gap-[21px] gap-[24px] grid grid-cols-9 items-center justify-center lg:pl-[188px] xl:pl-[215px] 2xl:pl-[242px] 3xl:pl-[290px] pl-[322.5px] lg:pr-[189px] xl:pr-[217px] 2xl:pr-[244px] 3xl:pr-[293px] pr-[325.5px] w-[100%]">
              <Column className="bg-white_A700 3xl:h-[109px] h-[120px] lg:h-[70px] xl:h-[81px] 2xl:h-[91px] items-center 3xl:w-[108px] w-[120px] lg:w-[70px] xl:w-[80px] 2xl:w-[90px]">
                <Image
                  ...
                  alt="Sweater"
                />
                <Text className="font-normal lg:mb-[11px] xl:mb-[12px] 2xl:mb-[14px] 3xl:mb-[17px] mb-[19px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-bluegray_100 w-[auto]">
                  Jacket
                </Text>
              </Column>
              <Column className="bg-white_A700 3xl:h-[109px] h-[120px] lg:h-[70px] xl:h-[81px] 2xl:h-[91px] items-center 3xl:w-[108px] w-[120px] lg:w-[70px] xl:w-[80px] 2xl:w-[90px]">
              ...
              <Column className="bg-white_A700 3xl:h-[109px] h-[120px] lg:h-[70px] xl:h-[81px] 2xl:h-[91px] items-center 3xl:w-[108px] w-[120px] lg:w-[70px] xl:w-[80px] 2xl:w-[90px]">
                <Image
                  ...
                  alt="Boot"
                />
                <Text className="font-normal lg:mb-[11px] xl:mb-[12px] 2xl:mb-[14px] 3xl:mb-[17px] mb-[19px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_800 w-[auto]">
                  Shoes
                </Text>
              </Column>
              <Column className="bg-white_A700 3xl:h-[109px] h-[120px] lg:h-[70px] xl:h-[81px] 2xl:h-[91px] items-center 3xl:w-[108px] w-[120px] lg:w-[70px] xl:w-[80px] 2xl:w-[90px]">
              ...
              <Column className="bg-white_A700 3xl:h-[109px] h-[120px] lg:h-[70px] xl:h-[81px] 2xl:h-[91px] items-center 3xl:w-[108px] w-[120px] lg:w-[70px] xl:w-[80px] 2xl:w-[90px]">
                <Image
                  ...
                  alt="Bra"
                />
                <Text className="font-normal lg:mb-[11px] xl:mb-[12px] 2xl:mb-[14px] 3xl:mb-[17px] mb-[19px] ml-[11px] lg:ml-[6px] xl:ml-[7px] 2xl:ml-[8px] mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] 3xl:mx-[9px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-bluegray_100 w-[auto]">
                  Underwear
                </Text>
              </Column>
              <Column className="bg-white_A700 3xl:h-[109px] h-[120px] lg:h-[70px] xl:h-[81px] 2xl:h-[91px] items-center 3xl:w-[108px] w-[120px] lg:w-[70px] xl:w-[80px] 2xl:w-[90px]">
        ...
        <Stack className="lg:h-[419px] xl:h-[480px] 2xl:h-[539px] 3xl:h-[647px] h-[718px] w-[100%]">
          <Image
            ...
            alt="placeholder"
          />
          <Column className="absolute bg-white_A700_82 inset-[0] items-start justify-center w-[100%]">
            <Button className="bg-white_A700 font-medium font-poppins xl:mt-[104px] 2xl:mt-[117px] 3xl:mt-[141px] mt-[157px] lg:mt-[91px] lg:mx-[165px] xl:mx-[188px] 2xl:mx-[212px] 3xl:mx-[254px] mx-[283px] 3xl:py-[10px] py-[12.06px] lg:py-[7px] xl:py-[8px] 2xl:py-[9px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-[24px] text-center text-gray_800 w-[14%]">
            ...
            <Text className="font-normal font-poppins lg:leading-[18px] xl:leading-[21px] 2xl:leading-[24px] 3xl:leading-[28px] leading-[32.00px] lg:mt-[23px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] mt-[40px] lg:mx-[165px] xl:mx-[188px] 2xl:mx-[212px] 3xl:mx-[254px] mx-[283px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_800 text-left w-[35%]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </Text>
            <Row className="bg-gray_800 font-poppins items-center justify-start xl:mb-[104px] 2xl:mb-[117px] 3xl:mb-[141px] mb-[157px] lg:mb-[91px] lg:mt-[46px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] mt-[80px] lg:mx-[165px] xl:mx-[188px] 2xl:mx-[212px] 3xl:mx-[254px] mx-[283px] w-[13%]">
        ...
        <Column className="items-center justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] mx-[auto] w-[85%]">
          ...
          <Row className="items-center justify-between lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
            ...
            <Column className="bg-gray_50 items-center w-[32%]">
              <Image
                ...
                alt="placeholder"
              />
              <Text className="font-medium leading-[normal] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] mx-[auto] lg:text-[21px] xl:text-[24px] 2xl:text-[27px] 3xl:text-[32px] text-[36px] text-center text-gray_800 w-[55%]">
                Brown <br />
                Casual Sneaker
              </Text>
              <Text className="font-medium xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] lg:text-[21px] xl:text-[24px] 2xl:text-[27px] 3xl:text-[32px] text-[36px] text-gray_500 w-[auto]">
                $299
              </Text>
              <Button className="bg-gray_800 font-bold lg:mb-[32px] xl:mb-[36px] 2xl:mb-[41px] 3xl:mb-[49px] mb-[55px] lg:mt-[28px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] mt-[48px] mx-[auto] lg:py-[10px] xl:py-[12px] 2xl:py-[13px] 3xl:py-[16px] py-[18.05px] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-center text-white_A700 w-[38%]">
                Add to Cart
              </Button>
            </Column>
            <Grid className="lg:gap-[18px] xl:gap-[21px] 2xl:gap-[24px] 3xl:gap-[28px] gap-[32px] grid grid-cols-2 w-[32%]">
        ...
        <Stack className="lg:h-[249px] xl:h-[285px] 2xl:h-[320px] 3xl:h-[384px] h-[426px] mt-[100px] lg:mt-[58px] xl:mt-[66px] 2xl:mt-[75px] 3xl:mt-[90px] mx-[auto] w-[85%]">
          <Column className="absolute items-start justify-start left-[2%] top-[8%] w-[13%]">
            ...
            <Text className="font-normal lg:leading-[18px] xl:leading-[21px] 2xl:leading-[24px] 3xl:leading-[28px] leading-[32.00px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-left text-white_A700 w-[100%]">
            ...
            >
              <Column className="bg-white_A700 items-center justify-center shadow-bs2 w-[100%]">
                <Image
                  ...
                  className="lg:h-[117px] xl:h-[134px] 2xl:h-[151px] 3xl:h-[181px] h-[200px] lg:mt-[21px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[33px] mt-[37.5px] mx-[auto] object-contain lg:w-[116px] xl:w-[133px] 2xl:w-[150px] 3xl:w-[180px] w-[200px]"
                  alt="blackbusiness"
                />
                ...
                <Text className="font-medium lg:mb-[21px] xl:mb-[25px] 2xl:mb-[28px] 3xl:mb-[33px] mb-[37.5px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_500 w-[auto]">
                  $299
                </Text>
              </Column>
              <Column className="bg-white_A700 items-center justify-center shadow-bs2 w-[100%]">
              ...
              <Column className="bg-white_A700 items-center justify-center mb-[1px] shadow-bs2 w-[100%]">
                ...
                <Text className="font-medium lg:mb-[21px] xl:mb-[24px] 2xl:mb-[27px] 3xl:mb-[33px] mb-[37.14px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_500 w-[auto]">
                  $299
                </Text>
              </Column>
          ...
          >
            <Column className="items-center justify-start w-[100%]">
              ...
              <Column className="items-center justify-start xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] w-[81%]">
                ...
                ></RatingBar>
                <Text className="font-medium xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_500 w-[auto]">
                  $299
                </Text>
              </Column>
            </Column>
          ...
          <Column className="bg-gray_800 items-center justify-end w-[100%]">
            <Row className="items-start justify-between lg:mt-[37px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] mt-[64px] w-[100%]">
              <Column className="items-start justify-start lg:mb-[12px] xl:mb-[14px] 2xl:mb-[16px] 3xl:mb-[19px] mb-[22px] 2xl:ml-[108px] 3xl:ml-[129px] ml-[144px] lg:ml-[84px] xl:ml-[96px] w-[13%]">
                ...
                <Text className="font-bold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[28px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] mt-[48px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-[24px] text-white_A700 w-[auto]">
                  Social Media
                </Text>
                <Image
            ...
            <Text className="font-normal lg:mb-[18px] xl:mb-[21px] 2xl:mb-[24px] 3xl:mb-[28px] mb-[32px] lg:mt-[37px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] mt-[64px] mx-[auto] not-italic 2xl:text-[10px] 3xl:text-[12px] text-[14px] lg:text-[8px] xl:text-[9px] text-bluegray_100 w-[auto]">
